...
Usᴇ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴋɴᴏᴡ ʜᴏᴡ ᴛᴏ ᴜsᴇ ᴍᴇ :- @SONICKUWALUPDATEKANHA
...
├📢 **Fʀᴀᴍᴇᴡᴏʀᴋ** : <a href=https://docs.pyrogram.org/>Pʏʀᴏꜰᴏʀᴋ 2.3.61</a>
├💮 **Lᴀɴɢᴜᴀɢᴇ** : <a href=https://www.python.org>Pʏᴛʜᴏɴ 3.13.2</a>
├💾 **Dᴀᴛᴀʙᴀsᴇ** : <a href=https://cloud.mongodb.com>MᴏɴɢᴏDB</a>
├🚨 **Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ** : <a href=https://t.me/SONICKUWALUPDATEKANHA>SONIC KUWAL UPDATE KANHA</a>
├🥏 **Cʜᴀɴɴᴇʟ** : <a href=https://t.me/SONICKUWALUPDATEKANHA>SONIC KUWAL UPDATE KANHA</a>
├👨‍💻 **Cʀᴇᴀᴛᴇʀ** :  @SONICKUWALUPDATEKANHA
╰───────────────⍟
"""
...
"""
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "Join : @SONICKUWALUPDATEKANHA \n For the list of Telegram bots. "
